...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // import { forEachChild } from "typescript";
...
var API_KEY = "live_Pwz1DDFj6lR8faG9VyV09FQbvpJGHDGSuCGU9YTUlBmYHmVOZBsnw3uURi3fQbA0";
    ...
    while (1) switch (_context.prev = _context.next) {
      ...
      case 4:
        ...
        jsonData.forEach(function (ele) {
          var url = ele.url;
          var catID = ele.id;
          var altText = 'Image of the Cat' + catID;
          var createCarousel = Carousel.createCarouselItem(url, altText, catID);
          Carousel.appendCarousel(createCarousel);
          Carousel.start();
        });
        setTimeout(function () {
...
//# sourceMappingURL=/SR_ALAB_308A.4.1_CatAPI.e31bb0bc.js.map